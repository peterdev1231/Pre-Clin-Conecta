...
interface CustomLogoIconProps {
  className?: string;
  // Você pode adicionar mais props como fill, stroke, width, height se quiser torná-los dinâmicos
}

const CustomLogoIcon: React.FC<CustomLogoIconProps> = ({ className }) => {
  return (
    <svg 
      version="1.0" 
      ...
      width="450pt" 
      height="428pt" 
      viewBox="0 0 450 428" // Removido .000000 para simplificar
      preserveAspectRatio="xMidYMid meet"
      className={className} // Aplicar className para estilização externa
      fill="currentColor" // ALTERADO DE #000000 para currentColor
      stroke="none"   // Mantido do SVG original
    >
      <g transform="translate(0.000000,428.000000) scale(0.100000,-0.100000)">
        {/* O fill e stroke foram removidos do <g> para herdar do <svg> ou serem controlados por CSS */}
